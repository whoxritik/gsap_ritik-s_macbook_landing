            ...
            <div className="controls">
                ...
                <div className="flex-center gap-5 mt-5">
                    ...
                    <div className="size-control">
                        <div onClick={() => setScale(0.06)} className={(scale === 0.06 ? 'bg-white text-black' : 'bg-transparent text-white')}>
                            <p>14"</p>
                        </div>
                        <div onClick={() => setScale(0.08)} className={(scale === 0.08 ? 'bg-white text-black' : 'bg-transparent text-white')}>
                            <p>16"</p>
                        </div>
                    </div>
                </div>
